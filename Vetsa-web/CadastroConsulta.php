...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="margin-left: -40px;">
                <form method="post">
                    <div class="form-group mt-4">
                        <h1 class="foco">Consulta</h1>
                        <label for="usuario">Horário</label>
                        <input type="time" class="form-control rounded-input" id="usuario" name="usuario" placeholder="Digite o horário aqui">
                    </div>

                    <div class="form-group mt-4">
                        <label for="senha">Data</label>
                        <input type="date" class="form-control rounded-input" id="senha" name="senha" placeholder="Digite a data aqui">
                    </div>
            ...
            <div class="col-md-6">
                <img src="imgs/imagemconsulta.png" alt="imagem consulta" class="img-fluid" style="height: 500px;">
            </div>
        </div>
    </div>
