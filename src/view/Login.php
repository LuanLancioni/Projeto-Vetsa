                ...
                <form method="post">
                    ...
                    <div class="form-group mt-4">
                        <div class="text-align-left">
                            <p>Não possui um cadastro? <a href="Cadastro.php" class="foco">Cadastre-se</a></p>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-md-6">
                <img src="imgs/imagemcadastro.png" alt="imagem login" class="img-fluid">
            </div>
        </div>
    </div>
