    ...
    <div class="container mt-4">
        <form method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control rounded-input" id="nome" name="nome" disabled>
            </div>
            <div class="form-group mt-4">
                <label for="especie">Espécie</label>
                <input type="text" class="form-control rounded-input" id="especie" name="especie" disabled>
            </div>
            <div class="form-group mt-4">
                <label for="raca">Raça</label>
                <input type="text" class="form-control rounded-input" id="raca" name="raca" disabled>
            </div>
            <div class="form-group mt-4">
                <label for="genero">Gênero</label>
                <input type="text" class="form-control rounded-input" id="genero" name="genero"  disabled>
            </div>
            <div class="form-group mt-4">
                <label for="idade">Idade</label>
                <input type="number" class="form-control rounded-input" id="idade" name="idade" disabled>
            </div>
            <div class="form-group mt-4">
                <label for="cor">Cor</label>
                <input type="text" class="form-control rounded-input" id="cor" name="cor" disabled>
            </div>
            <div class="form-group mt-4">
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-custom w-100">Excluir</button>
                </div>
            </div>
        </form>
    </div>
